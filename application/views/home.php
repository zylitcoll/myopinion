...
<body>
    ...
    <main>
        <section class="hero-section text-center">
            <div class="container">
                ...
                <a href="<?= base_url(); ?>/input" class="btn btn-primary btn-lg rounded-pill" style="background-color: #4e73df; border: none;">Mulai Disini</a>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-4 mb-lg-0 d-flex flex-column justify-content-center">
                        ...
                        <a href="<?= base_url(); ?>/input" class="btn btn-outline-primary mt-3 align-self-start rounded-pill">Mulai Disini</a>
                    </div>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-6 mb-4">
                        <div class="card card-partner p-4 h-100 border-0 rounded-4">
                            <div class="text-center">
                                <img src="<?= base_url(); ?>set/img/bps.webp" class="img-fluid mb-3" alt="Logo BPS" style="max-height: 80px;">
                    ...
                    <div class="col-6 col-md-3 d-flex align-items-stretch">
                        <div class="card card-partner p-4 h-100 border-0 rounded-4 d-flex align-items-center justify-content-center">
                            <img src="<?= base_url(); ?>set/img/univ.png" class="img-fluid" alt="Logo Universitas" style="max-height: 100px;">
                        </div>
                    </div>
                    <div class="col-6 col-md-3 d-flex align-items-stretch">
                        <div class="card card-partner p-4 h-100 border-0 rounded-4 d-flex align-items-center justify-content-center">
                            <img src="<?= base_url(); ?>set/img/fak.jpeg" class="img-fluid" alt="Logo Fakultas" style="max-height: 100px;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        // JavaScript untuk header auto-scroll
